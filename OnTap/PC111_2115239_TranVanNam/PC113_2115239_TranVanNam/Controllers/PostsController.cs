...
using PagedList;
using PC113_2115239_TranVanNam.Models;

namespace PC113_2115239_TranVanNam.Controllers
{
    public class PostsController : Controller
    {
        ...
        // GET: Posts
        public ActionResult Index(string searchString, string sortOrder, int? size, int? page)
        {
			ViewBag.CurrentSort = sortOrder;
			ViewBag.TitleSortParm = String.IsNullOrEmpty(sortOrder) ? "title_desc" : "";
			ViewBag.ContentSortParm = sortOrder == "content_desc" ? "content_asc" : "content_desc";
